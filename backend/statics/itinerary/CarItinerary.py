...
def get_route(start_coords, end_coords, mode='driving'):
    """
    Calculate a car/driving route between two coordinates using OSRM.
    
    Args:
        start_coords: Tuple of (latitude, longitude) for start point
        end_coords: Tuple of (latitude, longitude) for end point
        mode: Transportation mode - 'driving' (default)
